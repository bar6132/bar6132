...
### 🚀 Full Stack Engineer | Technical Product Manager | AI & Cloud Architecture
...
- 💼 **Currently:** Full Stack Developer & TPM at **The Jerusalem Post Group** (Walla!, Maariv, JPost).
- 📈 **Impact:** Recently engineered caching tools that **reduced server load times by ~45%** for millions of monthly users.
- 🔭 **Working on:** High-availability microservices, Real-time publishing workflows, and Generative AI integration.
- 💬 **Ask me about:** .NET 8 vs Python for backend, RAG Systems, and effectively bridging business goals with engineering specs.
...
#### 🌩️ **[StorageX] Distributed Video Transcoding System**
...
#### 🤖 **[Project Maker Magician] AI-Powered Code Generator**
...
* **Performance Engineering:** Engineered custom `ImageLoader` & `Cache Control` systems, boosting Core Web Vitals and cutting load times by 45%.
